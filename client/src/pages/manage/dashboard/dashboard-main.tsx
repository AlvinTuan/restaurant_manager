...
import { useGetDashboardIndicatorQuery } from '@/pages/manage/dashboard/dashboard.service'
import { DishBarChart } from '@/pages/manage/dashboard/dish-bar-chart'
import { RevenueLineChart } from '@/pages/manage/dashboard/revenue-line-chart'
...
export default function DashboardMain() {
  ...
  const { data: getDashboardIndicatorRes } = useGetDashboardIndicatorQuery({
    fromDate: fromDate.toISOString(),
    toDate: fromDate.toISOString()
  })
  const data = getDashboardIndicatorRes?.data
