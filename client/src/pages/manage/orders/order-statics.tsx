...
import { ServingGuestByTableNumber, Statics, StatusCountObject } from '@/pages/manage/orders/order-table'
          ...
          return (
            ...
            >
              <div className='flex flex-col items-center justify-center gap-2'>
                <div className='text-lg font-semibold text-center'>{tableNumber}</div>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger>
